...
// Export signToken for use in other modules
exports.signToken = signToken;

// Admin only middleware - convenience wrapper around restrictTo
exports.adminOnly = exports.restrictTo('admin');

// Optional auth middleware - doesn't require auth but will set user if token is present
