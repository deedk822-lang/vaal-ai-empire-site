...
class PerformanceAgent(BaseAgent):
    ...
    async def execute(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        perf_config = {
            ...
            "optimizations": {
                "images": {"format": "webp", "lazy_load": True, "responsive": True},
                "css": {"critical_inline": True, "unused_remove": True, "minify": True},
                "js": {"defer": True, "async": False, "code_split": True},
                "fonts": {"display": "swap", "preload": True},
                "caching": {"static": "1year", "api": "1hour"},
            },
        }

        perf_file = self.write_file(
            "performance.config.json", json.dumps(perf_config, indent=2)
        )
        ...
        security_file = self.write_file(
            "security.config.json", json.dumps(security_config, indent=2)
        )
